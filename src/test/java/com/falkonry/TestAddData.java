...
public class TestAddData {
	...
	/*
	 * //@Test public void addWideDataJson() throws Exception { Datastream ds =
	 * new Datastream(); ds.setName("Test-EB-" + Math.random());
	 * ds.setEntityIdentifier("entity"); ds.setTimeIdentifier("time");
	 * ds.setTimeFormat("millis");
	 * 
	 * Datastream eventbuffer = falkonry.createDatastream(ds);
	 * datastreams.add(eventbuffer); String data =
	 * "{\"time\":1467729675422,\"entity\":\"entity1\",\"signal1\":41.11,\"signal2\":82.34,\"signal3\":74.63,\"signal4\":4.8,\"signal5\":72.01}";
	 * Map<String, String> options = new HashMap<String, String>();
	 ...
	 * 
	 * 
	 * //@Test public void addWideDataCsv() throws Exception { Datastream ds =
	 * new Datastream(); ds.setName("Test-EB-" + Math.random());
	 * ds.setEntityIdentifier("entity"); ds.setTimeIdentifier("time");
	 * ds.setTimeFormat("millis");
	 * 
	 * Datastream eventbuffer = falkonry.createDatastream(ds);
	 * datastreams.add(eventbuffer); String data =
	 * "time,entity,signal1,signal2,signal3,signal4,signal5\n" +
	 * "1467729675422,entity1,41.11,82.34,74.63,4.8,72.01"; Map<String, String>
